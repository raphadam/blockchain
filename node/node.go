...
import (
	...
	"github.com/raphadam/blockchain/pb"
...
func (bc *blockchain) add(block *pb.Block) error {
	// verify the version
	...
	log.Println("blockchain height", len(bc.chain), hex.EncodeToString(block.MinerKey))
